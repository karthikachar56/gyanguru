...
export const AdminNavbar: React.FC<AdminNavbarProps> = ({ pendingReviewCount }) => {
  return (
    <header className="sticky top-0 z-40 w-full border-b border-indigo-900/60 bg-slate-900/90 backdrop-blur-md shadow-lg shadow-indigo-950/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Admin Brand */}
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-purple-600 to-cyan-500 flex items-center justify-center text-white shadow-md shadow-indigo-500/30">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[10px] font-extrabold px-2.5 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 uppercase tracking-wider">
                  Control Center
                </span>
              </div>
